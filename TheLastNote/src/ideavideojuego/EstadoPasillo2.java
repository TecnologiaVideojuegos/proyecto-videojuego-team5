...
public class EstadoPasillo2 extends BasicGameState {
    ...
    public void init(GameContainer container, StateBasedGame game) throws SlickException {
        ...
        Ataque Muro = new Ataque(90, 5, "Muro", "Lanzará un muro pagado por todos causando un daño LETAL!!!", 50, new Sound(("Musica/Sonidos/fx_trap3.ogg")));
        DonaldTrap = new Personaje(500, "Donald Trap", new SpriteSheet("Design/DonaldTrapSprite1.png", 70, 176), DonaldD, DonaldI, null, null, null,null,null,DonaldC,null);
